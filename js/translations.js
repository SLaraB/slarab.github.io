const translations = {
  es: {
    ...
    achievements_conf_3_title: "Artículo publicado en Construction and Building Materials",
    achievements_conf_3_event: "Viscoelastic evaluation of bituminous mixtures with high RAP content using a circular accelerated pavement deterioration simulator based on a fractional model",
    achievements_conf_3_authors: "M. Lagos-Varas, S. Lara-Barría, I. Indacoechea-Vega, M. González-González, D. Castro-Fresno",
    achievements_conf_3_link: "Ver artículo en ScienceDirect",
    achievements_conf_4_title: "Ponente en Congreso de Innovación en Construcción, Edificación, Infraestructuras y Concesiones",
    achievements_conf_4_event: "Sistema avanzado de detección y medición automática de grietas en pavimentos mediante inteligencia artificial, visión por computador y aprendizaje profundo",
    achievements_conf_4_location: "Santander, España | 1-5 de junio de 2026",
    ...
    achievements_proj_5_title: "Sistema avanzado de detección y medición automática de grietas en pavimentos",
    achievements_proj_5_org: "LIAISON EU PROJECT",
    achievements_proj_5_location: "Santander, España",
    achievements_proj_5_desc: "Desarrollo de un sistema avanzado para la detección y medición automática de grietas en pavimentos mediante inteligencia artificial, visión por computador y aprendizaje profundo.",
  ...
  en: {
    ...
    achievements_conf_2_event: "ChileCon IEEE",
    achievements_conf_2_location: "Valdivia, Chile",
    achievements_conf_3_title: "Article published in Construction and Building Materials",
    achievements_conf_3_event: "Viscoelastic evaluation of bituminous mixtures with high RAP content using a circular accelerated pavement deterioration simulator based on a fractional model",
    achievements_conf_3_authors: "M. Lagos-Varas, S. Lara-Barría, I. Indacoechea-Vega, M. González-González, D. Castro-Fresno",
    achievements_conf_3_link: "View article on ScienceDirect",
    achievements_conf_4_title: "Speaker at the Congress on Innovation in Construction, Building, Infrastructure and Concessions",
    achievements_conf_4_event: "Advanced system for automatic pavement crack detection and measurement using artificial intelligence, computer vision, and deep learning",
    achievements_conf_4_location: "Santander, Spain | June 1-5, 2026",
    ...
    achievements_proj_5_title: "Advanced system for automatic pavement crack detection and measurement",
    achievements_proj_5_org: "LIAISON EU PROJECT",
    achievements_proj_5_location: "Santander, Spain",
    achievements_proj_5_desc: "Development of an advanced system for automatic pavement crack detection and measurement using artificial intelligence, computer vision, and deep learning.",
